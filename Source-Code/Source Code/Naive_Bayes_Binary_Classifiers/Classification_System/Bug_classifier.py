...
class Bug_classifier:
    ...
    def __init__(self):
        ...
        self.db = db
        self.cur = cur 
        self.train ,self.rating_dict , self.test , self.senti_dict , self.senti_pos_dict ,self.senti_neg_dict ,self.present_simple_dict ,self.past_simple_dict ,self.future_dict ,self.present_con_dict  = Bug_classifier.classifier_fetch_data(self)
        print('Training the Classifier (Bug Classifier)')
    ...
    def classifier_fetch_data(self):
        ...
        for row in self.cur.fetchall() :
            ...
            train.append((decoded_row, 'Not_Bug_Report'))
    ...
    def probability(self,text):
        ...
        print "probaility of having a bug report review" 
        print prob_dist.prob("bug")
        print "classified as :"
        print prob_dist.max()


def main():
    Classifier = Bug_classifier()
